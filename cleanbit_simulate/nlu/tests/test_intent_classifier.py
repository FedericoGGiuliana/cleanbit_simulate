...
CASES = [
    ...
    ("vai in bagno evitando camera e salotto", "GO_TO_AREA"),
    ("vai in cucina evitando il bagno e il salone", "GO_TO_AREA"),
    ("vai in cucina evitando bagno, salone e corridoio", "GO_TO_AREA"),
    ("vai in cucina evitando bagno, salone, camera e corridoio", "GO_TO_AREA"),
    ("vai in cucina ma evita bagno, salone e corridoio", "GO_TO_AREA"),
    ("vai in cucina senza passare da bagno, salone e corridoio", "GO_TO_AREA"),
    ("vai in cucina, non passare da bagno né da salone né da camera", "GO_TO_AREA"),
    ("vai in camera", "GO_TO_AREA"),
