...
class RoomEditor:
    ...
    def _render(self):
        ...
        for room in self.rooms:
            ...
            draw.rectangle([x1, y1, x1 + label_width, y1 + 16], fill=color)
    ...
    def _get_rooms_json_path(self):
        ...
        try:
            ...
            candidate = os.path.join(package_share, 'maps', 'rooms.json')
        ...
        raise FileNotFoundError(
            "Cartella maps non trovata. Controlla che esista cleanbit_simulate/maps"
        )
    ...
    def _load_rooms(self):
        ...
        if not os.path.exists(path):
            messagebox.showinfo(
                'Info',
                f'Nessun file rooms.json trovato in:\n{path}'
            )
            return
