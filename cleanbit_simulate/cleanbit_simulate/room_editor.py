...
class RoomEditor:
    ...
    def _save_rooms(self):
        ...
        try:
            ...
            print(f'[INFO] File JSON salvato/sovrascritto in: {path}')

        except Exception as e:
            messagebox.showerror(
                'Errore salvataggio',
                f'Impossibile salvare room.json:\n{e}'
            )
            print(f'[ERROR] Impossibile salvare room.json: {e}')
